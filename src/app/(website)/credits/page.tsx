...
export default function CreditsPage() {
  return (
    <Container className="mt-12 max-w-3xl space-y-10 rounded-3xl bg-white/90 p-10 shadow-xl backdrop-blur-sm text-zinc-800 dark:bg-zinc-900/90 dark:text-zinc-100 dark:shadow-black/30">
      <header>
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          {socialLinks.map(({ label, href, Icon }) => (
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-full border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 transition hover:border-zinc-400 hover:text-zinc-900 dark:border-zinc-700 dark:text-zinc-200 dark:hover:border-zinc-500 dark:hover:text-zinc-100"
              aria-label={label}
            >
      ...
      <footer className="pb-12 text-sm text-zinc-500 dark:text-zinc-400">
